...
  const [selectedMessage, setSelectedMessage] = useState<typeof initialMessages[number] | null>(
    null
  );
...
  const [isNewMessageDropdownOpen, setIsNewMessageDropdownOpen] = useState(false);
...
              <input type="email" style={newMessageInputStyle} placeholder="Recipient's Email" />
            </div>
            <div style={newMessageFormGroupStyle}>
              <label style={newMessageLabelStyle}>Subject:</label>
              <input type="text" style={newMessageInputStyle} placeholder="Subject" />
            </div>
            <div style={newMessageFormGroupStyle}>
              <label style={newMessageLabelStyle}>Message:</label>
              <textarea style={newMessageTextareaStyle} placeholder="Write your message here..." />
            </div>
          </>
        );
      case "WhatsApp":
...
            <div style={newMessageFormGroupStyle}>
              <label style={newMessageLabelStyle}>To:</label>
              <input type="tel" style={newMessageInputStyle} placeholder="Recipient's Phone Number" />
            </div>
            <div style={newMessageFormGroupStyle}>
              <label style={newMessageLabelStyle}>Message:</label>
              <textarea style={newMessageTextareaStyle} placeholder="Write your message here..." />
...
            <div style={newMessageFormGroupStyle}>
              <label style={newMessageLabelStyle}>To:</label>
              <input type="text" style={newMessageInputStyle} placeholder="Recipient's Profile URL" />
            </div>
            <div style={newMessageFormGroupStyle}>
              <label style={newMessageLabelStyle}>Subject:</label>
              <input type="text" style={newMessageInputStyle} placeholder="Subject" />
...
    ...pageContainerStyle,
    filter: isNewMessageModalOpen ? "blur(2px) grayscale(50%)" : "none",
  };
...
            <h2 style={{ margin: 0, fontSize: "20px", fontWeight: 600, color: "#2d334a" }}>
              Inbox
            </h2>
...
                    <span style={messageSenderStyle(msg.read)}>{msg.sender}</span>
...
              <div>
                <div style={messageDetailsSenderStyle}>{selectedMessage.sender}</div>
                <h3 style={messageDetailsSubjectStyle}>{selectedMessage.subject}</h3>
              </div>
              <div style={messageDetailsTimestampStyle}>{selectedMessage.timestamp}</div>
            </div>
...
              <h3 style={{ margin: 0, fontWeight: 600 }}>New {selectedPlatform} Message</h3>
              <CloseOutlined
                style={{ fontSize: "18px", cursor: "pointer", color: "#636b91" }}

...
const initialDeals: Deal[] = [
  {
    id: "deal-1",
    dealName: "Tech Solutions Project",
    linkedLead: "Innovate Corp",
    value: "$50,000",
  ...
  {
    id: "deal-5",
    dealName: "New CRM Integration",
    linkedLead: "Nexus Innovations",
    value: "$30,000",
  ...
  {
    id: "deal-3",
    dealName: "Annual Contract Renewal",
    linkedLead: "Quantum Systems",
    value: "$120,000",
  ...
  {
    id: "deal-4",
    dealName: "Enterprise License Expansion",
    linkedLead: "DataStream Solutions",
    value: "$75,000",
...
const SortableDealCard = ({
  ...
  return (
    <div ref={setNodeRef} style={style} {...attributes} {...listeners}>
      <span style={{ fontWeight: 600, fontSize: 14, color: "#2c3e50" }}>
        {deal.dealName}
      </span>
      <span style={{ fontSize: 13, color: "#7f8c8d" }}>
        Linked Lead: {deal.linkedLead}
      </span>
...
export const DealsPage: React.FC = () => {
  ...
  const filteredStages = useMemo(() => {
    ...
    const filterByValue = (deal: Deal) => {
      ...
      if (valueFilter === "0-50k")
        return numericValue > 0 && numericValue <= 50000;
      if (valueFilter === "50-100k")
        return numericValue > 50000 && numericValue <= 100000;
    ...
    const filteredDeals = allDeals.filter((deal) => {
      const repMatch =
        salesRepFilter === "All Sales Reps" || deal.salesRep === salesRepFilter;
  ...
  const handleDragEnd = (event: DragEndEvent) => {
    ...
    const newStage =
      initialStagesConfig.find((stage) => stage.id === overId) ||
      initialStagesConfig.find(
        (stage) => stage.id === findDeal(overId)?.stageId,
      );
  ...
  const recentDeals = filteredStages
    .flatMap((stage) =>
      ...
      <div style={{ marginBottom: "24px" }}>
        ...
        >
          ...
          <Button
            ...
            style={{ borderRadius: 6, background: "#386fe3", fontWeight: 600 }}
          >
        ...
        >
                ...
                >
                  {stage.deals.map((deal) => (
                    <SortableDealCard
                      key={deal.id}
                      deal={deal}
                      isDragging={deal.id === activeDeal?.id}
                    />
                  ))}
                </SortableContext>
              </DroppableStage>
          ...
          <DragOverlay>
            {activeDeal ? (
              ...
              >
                <span
                  style={{ fontWeight: 700, fontSize: 15, color: "#1d293f" }}
                >
                  {activeDeal.dealName}
                </span>
                <span
                  style={{ color: "#34495e", fontWeight: 600, fontSize: 14 }}
                >
                  {activeDeal.value}
                </span>
        ...
        <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "conic-gradient(#386fe3 0 35%, #599cff 35% 70%, #90d3fe 70% 100%)",
              marginRight: 24,
              position: "relative",
            }}
          >
          ...
          <div>
            ...
            <p style={{ color: "#7f8c8d", fontSize: 14, margin: "8px 0 0 0" }}>
              Current distribution of deals across different stages in your
              sales pipeline. Focus on moving deals from Opportunity to Closed.
            </p>
            <div
              style={{
                display: "flex",
      ...
      >
        <Form form={form} onFinish={handleFormSubmit} layout="vertical">
          ...
          <Form.Item
            ...
            label="Linked Lead"
            rules={[
              { required: true, message: "Please enter the linked lead!" },
            ]}
          >
            <Input />
          </Form.Item>
          ...
          <Form.Item
            ...
            label="Close Date"
            rules={[
              { required: true, message: "Please enter the close date!" },
            ]}
          >
            <Input type="date" />
          </Form.Item>
          <Form.Item>
            <Button
              type="primary"
              htmlType="submit"
              style={{ width: "100%", background: "#386fe3", fontWeight: 600 }}
            >
              Create Deal
            </Button>
          </Form.Item>
